...
void GPU_Geometry::setTexCoords(const std::vector<glm::vec2>& texs) {
	texBuffer.uploadData(sizeof(glm::vec2) * texs.size(), texs.data(), GL_STATIC_DRAW);
}
